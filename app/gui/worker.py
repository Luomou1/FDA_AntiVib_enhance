...
class AnalysisWorker(QObject):
    ...
    def _load_input_cube(self) -> np.ndarray:
        ...
        return load_intensity_cube(files)
    ...
    def run(self) -> None:
        ...
        try:
            ...
            if self.params.active_range is not None:
                ...
                expansion_frames = self.params.active_range_expansion_frames if self.params.expand_active_range else 0
            ...
            if sample_positions is not None:
                self.log.emit(f"\u5df2\u52a0\u8f7d {sample_positions.shape[0]} \u4e2a\u975e\u5747\u5300\u91c7\u6837\u4f4d\u7f6e\u3002")

            self.progress.emit(35)
            self.log.emit(
                f"\u6b63\u5728\u5206\u6790\uff1a\u62df\u5408={self.params.fitting_method}\uff0c"
                f"\u89e3\u5305\u88f9={self.params.unwrap_method}\uff0c"
                f"工作流={self.params.phase_gap_method}\uff0c"
            ...
            result = analyze_cube_fast(
                ...
                phase_gap_method=self.params.phase_gap_method,
...
class GlobalK0Worker(QObject):
    ...
    def __init__(
        ...
        self.active_range_expansion_frames = int(active_range_expansion_frames)
    ...
    def run(self) -> None:
        ...
        try:
            ...
            cube = self._load_input_cube()
            sample_positions = self._resolve_sample_positions(cube.shape[2])
            expansion_frames = self.active_range_expansion_frames if self.expand_active_range else 0
            cube, sample_positions, active_range = apply_active_range(
                cube,
                sample_positions,
                expansion_frames=expansion_frames,
